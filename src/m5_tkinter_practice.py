...
def main():
    ...
    # ------------------------------------------------------------------
    button1['command'] = (lambda: do_stuff())
    button1.grid()
    # ------------------------------------------------------------------
    ...
    entry1.grid()
    button2 = ttk.Button(root, text="Press Me")
    button2.grid()
    button2['command'] = (lambda: print_things(entry1))
    # ------------------------------------------------------------------
    # DONE: 7.
    ...
    button3 = ttk.Button(frame1, text="Press Me3")
    button3.grid()
